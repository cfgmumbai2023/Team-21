    ...
    <FooterContainer>
      <FooterSection>
        <FooterTop>
          ...
          <FooterListUl>
            <FooterListLi><FooterLink href="#">BFSS Business</FooterLink></FooterListLi>
            <FooterListLi><FooterLink href="#">Teach on BFSS App</FooterLink></FooterListLi>
        ...
        <FooterBottom>
          ...
          <div className="h-1/6"><a href="https://www.indianfootballfoundation.org/"><img src={IFFLogo}/></a></div>
          <Copyright>&copy; 2023, Inc.</Copyright>
        </FooterBottom>
      </FooterSection>
    </FooterContainer>
  )
